...
powercoef_mean_sort_smooth_round = round(powercoef_mean_sorted_smoothed,1000);
...
contour(independent_var,A_star_sorted,powercoef_mean_sort_smooth_round,[0 0],'LineWidth',4,'LineColor','k','LineStyle','--')
