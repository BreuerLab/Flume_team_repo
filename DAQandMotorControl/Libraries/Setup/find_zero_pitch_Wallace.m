function [last_out,bias] = find_zero_pitch_Wallace(dq,last_out,bias,foil)
...
[~,~,last_out] = move_new_pos_3rigs(dq,last_out,[0 0 0 0 5 0],2,bias,foil);
 [out,prof,last_out] = move_new_pos_3rigs(dq,last_out,[0 0 0 0 -5 0],10,bias,foil);
...
%Lift = (1:numel(Lift)-b)./a)
 [out,prof2,last_out] =  move_new_pos_3rigs(dq,last_out,[0 0 0 0 5 0],10,bias,foil);
...
if round(f(2)) < 0 || round(f(2)) > numel(prof(:,5))
 ...
 [~,~,last_out] =   move_new_pos_3rigs(dq,last_out,[0 0 0 0 15 0],2,bias,foil);
 [out,prof,last_out] =  move_new_pos_3rigs(dq,last_out,[0 0 0 0 -15 0],10,bias,foil);
    ...
    plot(1:numel(prof(:,1)),prof(:,5),1:numel(out(:,8)),smooth(Lift,100),1:numel(Lift),((1:numel(Lift))-f(2))./f(1))
    hold on
 [out,prof2,last_out] =  move_new_pos_3rigs(dq,last_out,[0 0 0 0 15 0],10,bias,foil);
