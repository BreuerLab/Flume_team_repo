...
% working directory:
cd('\\lrs.brown.edu\research\ENG_Breuer_Shared\group\Flume PIV\Flume PIV\tandem foils\20221006_wake-foil_interactions_alphaT4\20221006_alpha=68_p3=75_h3=0.8_ph=-120_f=0.6492\SideBySide_PIV_MPd(4x32x32_75%ov_ImgCorr)_GPU\Export\single_foil');
...
for n = 1:frame
    ...
    h = figure;
    set(h,'color','w','unit','centimeters','position',[2,2,15,20]); % for vorticity and forces
...
%     frame = 2*(n + 2);
    ...
    plot(foil2_coords([1,3,5])+3, foil2_coords([2,4,6]), 'k', 'LineWidth', 10); hold off; % plot trailing foil
...
gifname = '20221006_SingleFoilCropped_aT4=0.68_p3=75_h3=0.8c_ph=-120.gif';
