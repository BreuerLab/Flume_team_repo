...
function   [eff, par] = calculate_efficiency(kin, res, par, foil, EP)
    ...
    [eff.beta_2, eff.U_prime_2, eff.Eff_2_prime] = ...
        blockage_houlsby(kin.p2_meas, eff.CD2, EP.H2, eff.Eff_2, par.U, par.Fr, foil, EP.flume_height);
    
    [eff.beta_3, eff.U_prime_3, eff.Eff_3_prime] = ...
        blockage_houlsby(kin.p3_meas, eff.CD3, EP.H3, eff.Eff_3, par.U, par.Fr, foil, EP.flume_height);
