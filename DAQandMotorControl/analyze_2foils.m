...
out = filter_motor_noise_wallace(out, par.freq, par.srate, 20); % to show nice data, doesn't affect the efficiency calculation
out = filter_motor_noise_gromit(out, par.freq, par.srate, 20); % to show nice data, doesn't affect the efficiency calculation
