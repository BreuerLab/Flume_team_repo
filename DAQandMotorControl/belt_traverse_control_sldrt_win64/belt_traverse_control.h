 ...
 * C source code generated on : Thu Feb 16 11:49:00 2023
 *
...
#ifndef RTW_HEADER_belt_traverse_control_h_
#define RTW_HEADER_belt_traverse_control_h_
#ifndef belt_traverse_control_COMMON_INCLUDES_
#define belt_traverse_control_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                              /* belt_traverse_control_COMMON_INCLUDES_ */

#include "belt_traverse_control_types.h"
#include <stddef.h>
...
#define belt_traverse_control_rtModel  RT_MODEL_belt_traverse_control_T
...
typedef struct {
  ...
  void *theta_cmd_out_signal_ao1_PWORK;/* '<Root>/theta_cmd_out_signal_ao1' */
  void *theta_control_signal_ctr1_PFI13_PWORK;
                                  /* '<Root>/theta_control_signal_ctr1_PFI13' */
} DW_belt_traverse_control_T;

/* Backward compatible GRT Identifiers */
#define rtP                            belt_traverse_control_P
#define Parameters                     P_belt_traverse_control_T
#define rtDWork                        belt_traverse_control_DW
#define D_Work                         DW_belt_traverse_control_T

/* Parameters (default storage) */
struct P_belt_traverse_control_T_ {
  ...
  real_T y_cmd_ai0_MaxMissedTicks;   /* Mask Parameter: y_cmd_ai0_MaxMissedTicks
                                      ...
                                      */
  real_T theta_cmd_ai1_MaxMissedTicks;
  ...
  real_T y_control_signal_ctr0_out_PFI12_MaxMissedTicks;
                ...
                * Referenced by: '<Root>/y_control_signal_ctr0_out_PFI12'
                */
  real_T theta_cmd_out_signal_ao1_MaxMissedTicks;
  ...
  real_T y_cmd_ai0_YieldWhenWaiting;
                                    ...
                                    * Referenced by: '<Root>/y_cmd_ai0'
                                    */
  real_T theta_cmd_ai1_YieldWhenWaiting;
  ...
  real_T y_control_signal_ctr0_out_PFI12_YieldWhenWaiting;
              ...
              * Referenced by: '<Root>/y_control_signal_ctr0_out_PFI12'
              */
  real_T theta_cmd_out_signal_ao1_YieldWhenWaiting;
  ...
  int32_T y_control_signal_ctr0_out_PFI12_Channels;
                      ...
                      * Referenced by: '<Root>/y_control_signal_ctr0_out_PFI12'
                      */
  int32_T theta_cmd_out_signal_ao1_Channels;
  ...
  int32_T theta_control_signal_ctr1_PFI13_Channels;
                      ...
                      * Referenced by: '<Root>/theta_control_signal_ctr1_PFI13'
                      */
  int32_T y_cmd_ai0_RangeMode;         /* Mask Parameter: y_cmd_ai0_RangeMode
                                        * Referenced by: '<Root>/y_cmd_ai0'
                                        */
  int32_T theta_cmd_ai1_RangeMode;    /* Mask Parameter: theta_cmd_ai1_RangeMode
                                       * Referenced by: '<Root>/theta_cmd_ai1'
                                       */
  int32_T y_cmd_out_signal_ao0_RangeMode;
                               /* Mask Parameter: y_cmd_out_signal_ao0_RangeMode
                                * Referenced by: '<Root>/y_cmd_out_signal_ao0'
                                */
  int32_T theta_cmd_out_signal_ao1_RangeMode;
                           /* Mask Parameter: theta_cmd_out_signal_ao1_RangeMode
                            * Referenced by: '<Root>/theta_cmd_out_signal_ao1'
                            */
  int32_T y_cmd_ai0_VoltRange;         /* Mask Parameter: y_cmd_ai0_VoltRange
                                        * Referenced by: '<Root>/y_cmd_ai0'
                                        */
  int32_T theta_cmd_ai1_VoltRange;    /* Mask Parameter: theta_cmd_ai1_VoltRange
                                       * Referenced by: '<Root>/theta_cmd_ai1'
                                       */
  int32_T y_cmd_out_signal_ao0_VoltRange;
                               /* Mask Parameter: y_cmd_out_signal_ao0_VoltRange
                                * Referenced by: '<Root>/y_cmd_out_signal_ao0'
                                */
  int32_T theta_cmd_out_signal_ao1_VoltRange;
  ...
  real_T Saturation3_LowerSat;         /* Expression: -10
                                        * Referenced by: '<Root>/Saturation3'
                                        */
  real_T y_offsetm_Value;              /* Expression: 0
                                        * Referenced by: '<Root>/y_offset [m]'
                                        */
  real_T RateLimiter3_RisingLim;       /* Expression: 0.08
                                        * Referenced by: '<Root>/Rate Limiter3'
                                        */
  real_T RateLimiter3_FallingLim;      /* Expression: -0.08
                                        * Referenced by: '<Root>/Rate Limiter3'
                                        */
  real_T RateLimiter3_IC;              /* Expression: 0
                                        * Referenced by: '<Root>/Rate Limiter3'
                                        */
  real_T y_cmd_V2m_Gain;               /* Expression: 0.05
  ...
  real_T Saturation1_UpperSat;         /* Expression: 10000
                                        ...
                                        */
  real_T Saturation1_LowerSat;         /* Expression: 5000
                                        * Referenced by: '<Root>/Saturation1'
                                        */
  ...
  real_T Saturation4_LowerSat;         /* Expression: -10
                                        * Referenced by: '<Root>/Saturation4'
                                        */
  real_T theta_offsetdeg_Value;        /* Expression: 0
                                        * Referenced by: '<Root>/theta_offset [deg]'
                                        */
  real_T RateLimiter6_RisingLim;       /* Expression: 30
                                        * Referenced by: '<Root>/Rate Limiter6'
                                        */
  real_T RateLimiter6_FallingLim;      /* Expression: -30
                                        * Referenced by: '<Root>/Rate Limiter6'
                                        */
  real_T RateLimiter6_IC;              /* Expression: 0
                                        * Referenced by: '<Root>/Rate Limiter6'
                                        */
  real_T theta_cmd_V2deg_Gain;         /* Expression: 36
...
struct tag_RTM_belt_traverse_control_T {
  const char_T *path;
...
extern P_belt_traverse_control_T belt_traverse_control_P;

/* Block states (default storage) */
extern DW_belt_traverse_control_T belt_traverse_control_DW;

/* Model entry point functions */
extern void belt_traverse_control_initialize(void);
extern void belt_traverse_control_output(void);
extern void belt_traverse_control_update(void);
extern void belt_traverse_control_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern belt_traverse_control_rtModel *belt_traverse_control(void);
...
extern RT_MODEL_belt_traverse_control_T *const belt_traverse_control_M;
 ...
 *
 * '<Root>' : 'belt_traverse_control'
 */
#endif                                 /* RTW_HEADER_belt_traverse_control_h_ */
